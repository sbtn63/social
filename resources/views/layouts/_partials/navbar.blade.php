<nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        <a href="@if (Route::is('post.index')) {{ route('profile', Auth::user()->id) }} @else {{ route('post.index') }} @endif" class="flex items-center">
            <span class="self-center text-xl font-semibold hover:text-indigo-500 whitespace-nowrap dark:text-white">
